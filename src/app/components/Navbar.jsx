    ...
    <nav className="sticky top-0 z-50 w-full bg-white border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2 transition-transform hover:opacity-90">
          ...
          <span className="text-xl font-bold text-black tracking-tight">RecipeHub</span>
        </Link>
        ...
        <div className="relative group">
          ...
          {/* Dropdown Menu */}
          <div className="absolute right-0 top-full mt-2 w-48 py-2 bg-white shadow-xl rounded-xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
            <Link 
              href="/dashboard" 
