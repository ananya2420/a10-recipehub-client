  ...
  return (
    <div className="p-8">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        {[
          { label: "Published Recipes", count: "0" },
          { label: "Saved Favorites", count: "0" },
          { label: "Total Engagement", count: "0" },
        ].map((stat) => (
          <div key={stat.label} className="bg-white dark:bg-black-900 p-6 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm">
      ...
      <section className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-100 dark:border-gray-800 flex justify-between items-center mb-12">
        <div className="flex items-center gap-3">
          ...
          <p className="font-medium text-gray-600">Storage Limit: 0/2 Recipes</p>
        </div>
